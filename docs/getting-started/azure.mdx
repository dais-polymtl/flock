...
Before starting, ensure you have followed the [Getting Started](/getting-started/overview) guide to setup Flock. Next you
...
CREATE MODEL(
   ...
   'gpt-4o',
   'azure',
   {"tuple_format": "json", "max_batch_size": 32, "model_parameters": {"temperature": 0.7}}
);
```
