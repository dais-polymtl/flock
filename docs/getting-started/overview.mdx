...
such as **OpenAI**, **Azure**, **Ollama**, **Anthropic/Claude**, and **TypeSafe/Jev**.
...
<Columns cols={2}>
  ...
  <Card title="TypeSafe / Jev" icon="scale-balanced" href="/getting-started/typesafe">
    Set up Flock with TypeSafe / Jev.
  </Card>
</Columns>
