...
- **Browser & WASM Support**: Flock runs as a DuckDB-WASM loadable extension in modern browsers. See [Browser and WASM](/wasm).
...
Flock provides [**structured output**](/structured-output) capabilities that allow users to obtain predictable,
