...
- [OpenAI](/getting-started/openai)
- [Azure](/getting-started/azure)
- [Anthropic](/getting-started/anthropic) (for completions/vision only, no audio)
...
For image-specific workflows, see the [Image Support](/image-support) page.
