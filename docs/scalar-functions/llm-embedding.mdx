...
Not supported directly. Describe the image with [`llm_complete`](/scalar-functions/llm-complete) (`type: 'image'`), then embed the description.
...
Not supported on raw audio. Transcribe with [`llm_complete`](/scalar-functions/llm-complete) (`type: 'audio'`), then embed the transcript.
