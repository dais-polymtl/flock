...
SELECT
  ...
  llm_complete(
    {'model_name': 'gpt-4o'},
    {
      'prompt': 'Write a one-sentence product blurb.',
...
SELECT
  ...
  llm_complete(
    {'model_name': 'gpt-4o'},
    {
      'prompt': 'Describe this product image, focusing on key features.',
      'context_columns': [
        {'data': product_name},
