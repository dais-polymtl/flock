...
TEST(FusionCombSUM, With2Doubles) {
...
TEST(FusionCombSUM, With2Columns) {
    // Define the column types (2 DOUBLE columns)
    const duckdb::vector<duckdb::LogicalType> types = {duckdb::LogicalType::DOUBLE, duckdb::LogicalType::DOUBLE};
...
TEST(FusionCombSUM, With3Columns) {
...
TEST(FusionCombSUM, WithSomeNullNaNValues) {
    // Define the column types (2 DOUBLE columns)
    const duckdb::vector<duckdb::LogicalType> types = {duckdb::LogicalType::DOUBLE, duckdb::LogicalType::DOUBLE};
...
TEST(FusionCombSUM, WithEntireNullNaNColumn) {
    // Define the column types (2 DOUBLE columns)
    const duckdb::vector<duckdb::LogicalType> types = {duckdb::LogicalType::DOUBLE, duckdb::LogicalType::DOUBLE};
...
TEST(FusionCombSUM, WithOnlyNullNaNValues) {
    // Define the column types (2 DOUBLE columns)
    const duckdb::vector<duckdb::LogicalType> types = {duckdb::LogicalType::DOUBLE, duckdb::LogicalType::DOUBLE};
