...
TEST(FusionCombMED, With2Doubles) {
    ...
    const std::vector<double> result = flock::FusionCombMED::Operation(chunk);
...
TEST(FusionCombMED, With2Columns) {
    // Define the column types (2 DOUBLE columns)
    const duckdb::vector<duckdb::LogicalType> types = {duckdb::LogicalType::DOUBLE, duckdb::LogicalType::DOUBLE};
...
TEST(FusionCombMED, With3Columns) {
...
TEST(FusionCombMED, WithSomeNullNaNValues) {
    // Define the column types (2 DOUBLE columns)
    const duckdb::vector<duckdb::LogicalType> types = {duckdb::LogicalType::DOUBLE, duckdb::LogicalType::DOUBLE};
...
TEST(FusionCombMED, WithEntireNullNaNColumn) {
    // Define the column types (2 DOUBLE columns)
    const duckdb::vector<duckdb::LogicalType> types = {duckdb::LogicalType::DOUBLE, duckdb::LogicalType::DOUBLE};
...
TEST(FusionCombMED, WithOnlyNullNaNValues) {
    // Define the column types (2 DOUBLE columns)
    const duckdb::vector<duckdb::LogicalType> types = {duckdb::LogicalType::DOUBLE, duckdb::LogicalType::DOUBLE};
