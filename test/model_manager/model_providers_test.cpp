...
TEST(ModelProvidersTest, OpenAIProviderTest) {
    ...
    EXPECT_CALL(mock_provider, AddCompletionRequest(test_prompt, true, OutputType::STRING))
            .Times(1);
    ...
    mock_provider.AddCompletionRequest(test_prompt, true, OutputType::STRING);
